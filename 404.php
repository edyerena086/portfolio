...
<head>
    ...
    <!-- page title -->
    <title>
    	¡Ups! la pagina que estas buscando no existe - Omar Gonzalez
    </title>
</head>
...
<body>
	...
	<div class="main-wrappers">
		...
		<div class="container-fluid">
			<div class="row slider slider-404">
				<div class="col-xl-12 justify-content-center d-flex align-items-center">
					<h1 class="text-center">
						¡Ups error 404!<br/><span style="font-size: 2.5rem;">la pagina que buscas no esta.</span>
					</h1>
				</div>
			</div>
		</div>
